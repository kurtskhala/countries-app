...
const EditCountry: React.FC<AddCountryProps> = ({
  onEdit,
  setIsEditing,
  country,
  content,
  ...
  const [formData, setFormData] = useState<CountyFormData>({
    ...
    population: {
      en: country.population.en,
      ka: country.population.ka,
    },
    flag: country.flag,
  });
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    setIsEditing(false);
    const updatedData = { ...country, ...formData };
    onEdit(updatedData, country.id);
  };

  return (
    <form className={styles.editCountry} onSubmit={handleSubmit}>
